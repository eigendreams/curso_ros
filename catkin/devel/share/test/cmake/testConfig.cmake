...
if("TRUE" STREQUAL "TRUE")
  set(test_SOURCE_PREFIX /home/viki/curso_ros/catkin/src/test)
  set(test_DEVEL_PREFIX /home/viki/curso_ros/catkin/devel)
  set(test_INSTALL_PREFIX "")
  set(test_PREFIX ${test_DEVEL_PREFIX})
else()
  set(test_SOURCE_PREFIX "")
  set(test_DEVEL_PREFIX "")
  set(test_INSTALL_PREFIX /home/viki/curso_ros/catkin/install)
...
if(NOT "/home/viki/curso_ros/catkin/src/test/scripts" STREQUAL "")
  set(test_INCLUDE_DIRS "")
  set(_include_dirs "/home/viki/curso_ros/catkin/src/test/scripts")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'test' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'jakob <jakob.culebro@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/viki/curso_ros/catkin/src/test/${idir}'.  Ask the maintainer 'jakob <jakob.culebro@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/viki/curso_ros/catkin/devel/lib;/opt/ros/indigo/lib)
